...
#include "main.h"
/**
 * _strlen - It  calculate and return string length
 * @string: strg
...
/**
 * string_nconcat -  It concatenate s1 and n bytes of s2; return ptr to string
 * @s1: string 1
 * @s2: string 2
 * @n: n bytes to concat from string 2
 * Return: String concentation to the pointer.
 */
